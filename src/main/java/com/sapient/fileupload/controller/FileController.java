package com.sapient.fileupload.controller;
...
import com.sapient.fileupload.payload.FileResponse;
import com.sapient.fileupload.service.FileService;
...
public class FileController {
	...
	public ResponseEntity<FileResponse> fileUpload(@RequestParam("image")MultipartFile image){
		...
		return new ResponseEntity<FileResponse>(new FileResponse(uploadImageName,"Image is successfully uploaded!!"),HttpStatus.OK);
